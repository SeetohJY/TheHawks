...
//        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        MenuInflater searchMenuInflater = getMenuInflater();
        //MenuInflater navMenuInflater = getMenuInflater();
        searchMenuInflater.inflate(R.menu.search_menu, menu);
        //navMenuInflater.inflate(R.menu.navigation_menu, menu);
        return true;
    }
